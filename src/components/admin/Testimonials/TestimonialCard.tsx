    ...
    <>
      <Card className="border-leaf-border bg-white flex flex-col justify-between">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              <Avatar className="size-10 border border-leaf-border">
                ...
                />
                <AvatarFallback className="bg-leaf-soft text-leaf-green-dark font-semibold">
                  {testimonial.student_name.charAt(0).toUpperCase()}
                </AvatarFallback>
              </Avatar>

              <div>
                <h3 className="font-semibold text-leaf-navy text-sm sm:text-base">
        ...
        <CardContent className="space-y-4 pt-0 flex-1 flex flex-col justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2 pt-3 border-t border-leaf-border/60">
            {testimonial.course && (
              <Badge
                variant="outline"
                className="border-leaf-border text-leaf-navy text-xs"
              >
                {testimonial.course}
              </Badge>
            )}
            ...
            {testimonial.is_featured && (
              <Badge className="bg-leaf-soft text-leaf-green-dark hover:bg-leaf-soft text-xs">
                Featured
              </Badge>
            )}
            ...
            <Badge
              className={
                testimonial.is_active
                  ? "bg-leaf-soft text-leaf-green-dark hover:bg-leaf-soft text-xs"
